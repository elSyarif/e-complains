...
class CreateMsinspekTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('msinspek', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('tiket_id')->unsigned();
            $table->integer('memo_id')->unsigned();
            $table->string('category', 100);
            $table->string('result')->comment('Hasil Inspeksi berupa OK/NG');
