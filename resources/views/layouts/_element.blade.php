...
<head>
    ...
    <title>Agencyclick I Form Element</title>
    ...
    <!-- Toggles CSS -->
    <link href="../theme/vendors4/jquery-toggles/css/toggles.css" rel="stylesheet" type="text/css">
    <link href="../theme/vendors4/jquery-toggles/css/themes/toggles-light.css" rel="stylesheet" type="text/css">

    <!-- ION CSS -->
    <link href="../theme/vendors4/ion-rangeslider/css/ion.rangeSlider.css" rel="stylesheet" type="text/css">
    <link href="../theme/vendors4/ion-rangeslider/css/ion.rangeSlider.skinHTML5.css" rel="stylesheet" type="text/css">

    <!-- select2 CSS -->
    <link href="../theme/vendors4/select2/dist/css/select2.min.css" rel="stylesheet" type="text/css" />

    <!-- Pickr CSS -->
    <link href="../theme/vendors4/pickr-widget/dist/pickr.min.css" rel="stylesheet" type="text/css" />

    <!-- Daterangepicker CSS -->
    <link href="../theme/vendors4/daterangepicker/daterangepicker.css" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <div class="hk-wrapper hk-alt-nav">
        ...
        <nav class="navbar navbar-expand-xl navbar-light fixed-top hk-navbar hk-navbar-alt">
            ...
            <a class="navbar-brand" href="#">
                <img class="brand-img d-inline-block align-top" src="theme/dist/img/logo-light.png" alt="brand" />
            </a>
                    ...
                    <li class="nav-item dropdown show-on-hover active">
                        ...
                        <div class="dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                            ...
                            <div class="sub-dropdown-menu show-on-hover">
                                ...
                                <div class="dropdown-menu open-right-side">
                                    <a class="dropdown-item active" href="form-element.html">Form Elements</a>
                        ...
                        <div class="notifications-nicescroll-bar">
                                ...
                                <div class="media">
                                    <div class="media-img-wrap">
                                        <div class="avatar avatar-sm">
                                            <img src="theme/dist/img/avatar1.jpg" alt="user" class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                            ...
                            <a href="javascript:void(0);" class="dropdown-item">
                                <div class="media">
                                    <div class="media-img-wrap">
                                        <div class="avatar avatar-sm">
                                            <img src="theme/dist/img/avatar2.jpg" alt="user" class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                                    <div class="media-body">
                                        <div>
                            ...
                            <a href="javascript:void(0);" class="dropdown-item">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div>
                                            <div class="notifications-text">You have a follow up with<span class="text-dark text-capitalize"> Agencyclick head</span> on <span class="text-dark text-capitalize">friday, dec 19</span> at <span class="text-dark">10.00 am</span></div>
                ...
                <li class="nav-item dropdown dropdown-authentication">
                    <a class="nav-link dropdown-toggle no-caret" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="media">
                            <div class="media-img-wrap">
                                <div class="avatar">
                                    <img src="theme/dist/img/avatar5.jpg" alt="user" class="avatar-img rounded-circle">
                                </div>
    ...
    <!-- jQuery -->
    <script src="../theme/vendors4/jquery/dist/jquery.min.js"></script>

    <!-- Bootstrap Core JavaScript -->
    <script src="../theme/vendors4/popper.js/dist/umd/popper.min.js"></script>
    <script src="../theme/vendors4/bootstrap/dist/js/bootstrap.min.js"></script>

    <!-- Jasny-bootstrap  JavaScript -->
    <script src="../theme/vendors4/jasny-bootstrap/dist/js/jasny-bootstrap.min.js"></script>
    ...
    <!-- Ion JavaScript -->
    <script src="../theme/vendors4/ion-rangeslider/js/ion.rangeSlider.min.js"></script>
    <script src="theme/dist/js/rangeslider-data.js"></script>

    <!-- Toggles JavaScript -->
    <script src="../theme/vendors4/jquery-toggles/toggles.min.js"></script>
    <script src="theme/dist/js/toggle-data.js"></script>

    <!-- Select2 JavaScript -->
    <script src="../theme/vendors4/select2/dist/js/select2.full.min.js"></script>
    <script src="theme/dist/js/select2-data.js"></script>

    <!-- Bootstrap Tagsinput JavaScript -->
    <script src="../theme/vendors4/bootstrap-tagsinput/dist/bootstrap-tagsinput.min.html"></script>

    <!-- Bootstrap Input spinner JavaScript -->
    <script src="../theme/vendors4/bootstrap-input-spinner/src/bootstrap-input-spinner.js"></script>
    <script src="theme/dist/js/inputspinner-data.js"></script>

    <!-- Pickr JavaScript -->
    <script src="../theme/vendors4/pickr-widget/dist/pickr.min.js"></script>
    <script src="theme/dist/js/pickr-data.js"></script>

    <!-- Daterangepicker JavaScript -->
    <script src="../theme/vendors4/moment/min/moment.min.js"></script>
    <script src="../theme/vendors4/daterangepicker/daterangepicker.js"></script>
